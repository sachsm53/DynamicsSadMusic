...
# reader = reader.drop(reader.columns[[range(0,23)]], axis=1) #THIS IS FOR STUDYPOOL
# reader = reader.drop(reader.columns[[range(261,264)]], axis=1)
# reader = reader.drop(reader.columns[[range(298,301)]], axis=1)

#reader = reader.drop(reader.columns[[range(261,265)]], axis=1)
#test = reader.drop(reader.columns[[elem for elem in reader.columns if 'Submit' in elem]], axis=1)
...
#Output File
reader.to_csv(path_or_buf = "/Users/mattsachs/Documents/Sad_Music_Listening_Survey_USC_spring2015.csv")
reader.to_csv(path_or_buf = "/Users/mattsachs/Documents/music_experience_survey2.csv")
#reader.to_csv(path_or_buf = "/Users/mattsachs/Documents/Sad_Music_Listening_Survey_Turk.csv")



#Output Combined File
result.to_csv(path_or_buf = "/Users/mattsachs/Documents/Sad_Music_Listening_Survey_combine_2.csv")
csvfile.close()
